...
function computeMd5(str) {
  ...
  function add(n1, n2) {
    const l = (n1 & 0xffff) + (n2 & 0xffff);
    const m = (n1 >> 16) + (n2 >> 16) + (l >> 16);
    return (m << 16) | (l & 0xffff);
  }
  function rol(num, cnt) { return (num << cnt) | (num >>> (32 - cnt)); }
  function cmn(q, a1, b1, x1, s, t) { return add(rol(add(add(a1, q), add(x1, t)), s), b1); }
  function ff(a1, b1, c1, d1, x1, s, t) { return cmn((b1 & c1) | (~b1 & d1), a1, b1, x1, s, t); }
  function gg(a1, b1, c1, d1, x1, s, t) { return cmn((b1 & d1) | (c1 & ~d1), a1, b1, x1, s, t); }
  function hh(a1, b1, c1, d1, x1, s, t) { return cmn(b1 ^ c1 ^ d1, a1, b1, x1, s, t); }
  function ii(a1, b1, c1, d1, x1, s, t) { return cmn(c1 ^ (b1 | ~d1), a1, b1, x1, s, t); }
  function str2blks(s) {
  ...
  let a = 1732584193; let b = -271733879; let c = -1732584194; let
    d = 271733878;
  for (let i = 0; i < x.length; i += 16) {
    const olda = a; const oldb = b; const oldc = c; const
      oldd = d;
